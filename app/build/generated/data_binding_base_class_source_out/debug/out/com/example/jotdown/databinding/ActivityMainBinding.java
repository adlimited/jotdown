...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView listPersons;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull FloatingActionButton add,
      @NonNull Chip chip1, @NonNull Chip chip2, @NonNull ChipGroup chipGroup,
      @NonNull TextView hint, @NonNull ListView listPersons, @NonNull ImageView qrcode,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.list_persons;
      ListView listPersons = ViewBindings.findChildViewById(rootView, id);
      if (listPersons == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, add, chip1, chip2, chipGroup,
          hint, listPersons, qrcode, textView3);
    }
